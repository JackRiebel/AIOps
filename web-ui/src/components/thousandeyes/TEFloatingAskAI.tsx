...
export interface TEFloatingAskAIProps {
...
const quickQuestions = [
  'What tests are failing right now?',
  'Summarize active alerts and their impact',
  'Show me agent health across regions',
];

// ============================================================================
// TEFloatingAskAI Component
// ============================================================================

export const TEFloatingAskAI = memo(({ onNavigateToChat }: TEFloatingAskAIProps) => {
        ...
        {isOpen && (
          <div className="absolute bottom-16 right-0 w-80 bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700/50 overflow-hidden animate-in slide-in-from-bottom-2 fade-in duration-200">
            ...
            <div className="px-4 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white">
              ...
              <p className="text-xs text-cyan-100 mt-0.5">Ask questions about your ThousandEyes monitoring</p>
            </div>
...
TEFloatingAskAI.displayName = 'TEFloatingAskAI';

export default TEFloatingAskAI;
