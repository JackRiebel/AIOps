...
export default function Navigation() {
  ...
  const mainNavItems: NavItem[] = [
    ...
    { href: '/chat-v2', label: 'AIOps Chat', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z', permission: PERMISSIONS.NETWORK_VIEW, tourId: 'ai-chat' },
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-4 border-b" style={{ borderColor: 'var(--sidebar-border)' }}>
        <Link href="/" className="flex items-center gap-3" onClick={e => e.stopPropagation()}>
          ...
          {isExpanded && (
            <div>
              <h1 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>AI Ops</h1>
              <p className="text-xs" style={{ color: 'var(--text-muted)' }}>Center</p>
            </div>
          )}
        </Link>
